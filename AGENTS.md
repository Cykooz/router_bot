...
- `WOL_MAC`: The MAC address of the target device (e.g., `00:11:22:33:44:55`).
- `WOL_IP`: The destination IP address or hostname for the magic packet. If no port is specified, it defaults to port
  9 (e.g., `192.168.1.255` or `192.168.1.10:9`).
